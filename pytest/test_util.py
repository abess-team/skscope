from scope import BaseSolver, HTPSolver, GraspSolver, IHTSolver, FobaSolver, ForwardSolver, OMPSolver
import scope
import numpy as np
import pytest
...
solvers = (BaseSolver, HTPSolver, GraspSolver, IHTSolver, FobaSolver, foba_gdt_solver, ForwardSolver, OMPSolver)
