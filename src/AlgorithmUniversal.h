...
public:
    ...
    /**
      ...
      */
    double loss_function(UniversalData& active_data, Eigen::MatrixXd& y, Eigen::VectorXd& weights, Eigen::VectorXd& active_para, Eigen::VectorXd& aux_para, Eigen::VectorXi& A,
    ...
    /**
      ...
      */
    bool primary_model_fit(UniversalData& active_data, Eigen::MatrixXd& y, Eigen::VectorXd& weights, Eigen::VectorXd& active_para, Eigen::VectorXd& aux_para, double loss0,
    ...
    /**
      ...
      */
    void sacrifice(UniversalData& data, UniversalData& XA, Eigen::MatrixXd& y, Eigen::VectorXd& para, Eigen::VectorXd& beta_A, Eigen::VectorXd& aux_para, Eigen::VectorXi& A,
    ...
    double effective_number_of_parameter(UniversalData& X, UniversalData& active_data, Eigen::MatrixXd& y, Eigen::VectorXd& weights, Eigen::VectorXd& beta, Eigen::VectorXd& active_para,
        Eigen::VectorXd& aux_para) override;
};
#endif
