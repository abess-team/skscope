...
#else
List abessUniversal_API(ExternData data, UniversalModel model, NloptConfig nlopt_solver, int model_size, int sample_size, int aux_para_size, int max_iter, int exchange_num, int path_type,
